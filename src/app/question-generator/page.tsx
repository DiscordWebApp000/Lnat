      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center gap-8">
            ...
            <div className={`w-16 h-1 ${appState === 'questions' || appState === 'evaluation' ? 'bg-blue-600' : 'bg-gray-200'}`}></div>
            ...
            <div className={`flex items-center gap-2 ${appState === 'questions' ? 'text-blue-600' : appState === 'evaluation' ? 'text-green-600' : 'text-gray-400'}`}>
              ...
              <span className="font-medium">Question Solving</span>
            </div>
      ...
      <footer className="bg-white border-t mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-gray-600">
            <p>© {new Date().getFullYear()} LNAT Question Generator. Powered by OpenAI</p>
          </div>
        </div>
      </footer>
    </div>
