  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Text Input</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <textarea
            ...
            className="w-full h-48 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-black"
            required
            disabled={isLoading}
          />
        </div>
